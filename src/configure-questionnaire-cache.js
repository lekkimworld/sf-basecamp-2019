...
fetch(`${loginUrl}/services/oauth2/token`, {
    ...
    const promises = [
        ...
        return pool.query(`select name, sfid, sorting__c sorting, image__c image from salesforce.basecamp_question__c where version__c='${row.versionid}' order by sorting__c asc;`)
    }))
